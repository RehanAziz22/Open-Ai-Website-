...
export default function RephraseText() {
    ...
    const generateContent = async () => {
        const res = await openai.createCompletion({
            ...
            prompt: `Rephrase this text: ${productName}`,
            temperature: 0.8,
            max_tokens: 256,
            top_p: 1,
            frequency_penalty: 0,
        ...
        <Grid container sx={{ padding: 5, marginTop: 10 }}>
            ...
            <Grid item xs={12}>
                <Typography variant="h6" sx={{ marginY: 3, textAlign: "left" }} component="h2">
                    The online AI Rephraser is designed to provide you with quick and accurate Tweets for your product
                </Typography>
            </Grid>
            ...
            <Grid item xs={12}>
                <Typography variant="body1" sx={{ marginTop: 5,marginBottom:2, textAlign: "left" }} component="h2">
                    Type text you want to rephrase?
                </Typography>
            </Grid>
            <Grid item xs={12}   >
            ...
            <Grid item lg={12} sm={12}>
                <Box sx={{ backgroundColor: "#f5f5f5",borderRadius:"4px",padding:"20px",width:"100%" }}>
                    ...
                    <Typography sx={{ textAlign: "left", width: "100%", padding:"10px",fontWeight:"bold" }} variant="h5" component="h2">
                        AI Rephrase Text For : {productName.toUpperCase()}
                    </Typography>
                    <TextField
